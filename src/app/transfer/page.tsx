...
export default function TransferPage() {
  ...
  const { register, handleSubmit, reset } = useForm<TransferFormInputs>();
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <select {...register('transferType', { required: true })} className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-blue-500 focus:ring-blue-500 sm:text-sm">
                <option value="internal">Internal</option>
                <option value="external">Within Bank</option>
          ...
          <Button type="submit" loading={isLoading}>Submit Transfer</Button>
        </form>
      </div>
    </RequireAuth>
  );
